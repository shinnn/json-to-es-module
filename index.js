/*!
 * json-to-es-module | MIT (c) Shinnosuke Watanabe
...
module.exports = function jsonToEsModule(...args) {
  if (args.length === 0 || args.length > 2) {
    throw new TypeError(
      'Expected 1 or 2 arguments (str[, options]), but received ' +
  ...
  if (typeof options.indent !== 'string') {
    throw new TypeError(
      '`indent` option must be a string, but ' +
  ...
  if ('singleQuotes' in options) {
    if (typeof options.singleQuotes !== 'boolean') {
      throw new TypeError(
        '`singleQuotes` option must be a Boolean, but ' +
  ...
  if ('filter' in options) {
    if (typeof options.filter !== 'function') {
      throw new TypeError(
        '`filter` option must be a function, but ' +
  ...
  if ('inlineCharacterLimit' in options) {
    if (typeof options.inlineCharacterLimit !== 'number') {
      throw new TypeError(
        '`inlineCharacterLimit` option must be a number, but ' +
